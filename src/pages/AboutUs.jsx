      ...
      <section className='py-16'>
        <Container>
          <div className='grid grid-cols-2 gap-x-6'>
            ...
            <div className='pt-8'>
              <h2 className='text-[#151875] text-[36px] font-bold font-josefin pb-2'>Know About Our Ecomerce Business, History</h2>
              <p className='text-[#8A8FB9] text-[16px] font-semibold font-lato pb-2'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mattis neque ultrices mattis aliquam, malesuada diam est. Malesuada sem tristique amet erat vitae eget dolor lobortis. Accumsan faucibus vitae lobortis quis bibendum quam.</p>
              <div className='pt-8'>
                <Link to={"/contact"} target='_top' className='text-[#fff] text-[18px] font-bold font-josefin px-8 py-2 rounded-[5px] bg-[#FB2E86]'>
                  Contact us
                </Link>
              </div>
            </div>
