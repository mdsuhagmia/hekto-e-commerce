  ...
  return (
    <section>
      <Container>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-4 pb-12'>
          <div className='border-2 border-[#00000012] rounded-[5px] text-center shadow-md mb-4 lg:mb-0'>
            ...
            <p className='text-[#1a0b5b75] text-sm font-lato font-semibold pb-8 px-4 max-w-sm mx-auto'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Massa purus gravida.</p>
          </div>
          <div className='border-2 border-[#00000012] rounded-[5px] text-center shadow-md mb-4 lg:mb-0'>
            <div className='flex justify-center'>
